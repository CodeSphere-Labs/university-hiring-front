import { Flex, Loader, MultiSelect, Stack, Textarea, TextInput } from '@mantine/core';
import { useForm } from 'effector-forms';
import { useUnit } from 'effector-react';

import { $addProjectLoading, projectForm } from '@/pages/Profile/model/addProject.model';
import {
  ...
  return (
    <Stack>
      ...
      <MultiSelect
        ...
        onChange={(value) => fields.technologies.onChange(value)}
